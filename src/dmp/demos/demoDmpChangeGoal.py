...
if __name__=="__main__":
    ...
    args=sys.argv[1:]
    if len(args)!=1:
        print "Usage: python file.py <initial_trajectory_file>"
        sys.exit()
    else:
        initial_trajectory_file=args[0]
    ...
    subprocess.call([executable, directory, initial_trajectory_file])
